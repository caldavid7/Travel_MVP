...
export async function getOpenAIResponse({
  ...
  const actualPrompt = `Array of 10, ${processedPreference} hotels in ${location} with a 4 sentence description and 3 short blubs that guests have said or wrote in reviews of each in the format of a JSON array below [{"hotel_name":"","brief_description":"","blubs":[]}]`;
